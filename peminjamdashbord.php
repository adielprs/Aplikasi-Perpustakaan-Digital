...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                </span><span>Peminjaman</span></a></li>
    ...
    <div class="main-content">
        ...
        echo "Selamat datang, peminjam " . $_SESSION['username'];
        ?>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>STATUS PEMINJAMN</th>
                                </tr>
                            </thead>
                            <?php
                            include 'koneksi.php';
                            $query = "SELECT * FROM tpeminjaman";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $row['ttanggalpengembalian']; ?></td>
