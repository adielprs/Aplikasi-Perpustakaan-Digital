...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li><a href="admindashbord.php"><span class="ti-folder">
                ...
                <div class="activity-grid">
                    <div class="activity-card">
                        ...
                        <table class="mt-5">
                            ...
                            <?php
                            include 'koneksi.php';
                            $query ="SELECT * FROM `tusers` WHERE role='petugas'";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="hapuspetugas.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus Petugas ini?')"><i
                                            class='bx bx-x'></i></i>Hapus</>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php } ?>
